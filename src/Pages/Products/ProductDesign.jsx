...
import Section12 from "../HomePage/Section12.jsx";
import React, { useState } from "react";
import { useParams } from "react-router-dom";
import { ProductInformation } from "./ProductsInformation";
...
const ProductDesign = () => {
  ...
  // Get product Info {By Filter} In Product Store =} 
  ...
  return (
    <Box>
      {Product == undefined ? (
        <Box sx={{color :'red'}}> Error:* Sry Sir Product not found Make Sure OF Product Name </Box>
      ) : (
          
        <Box>
          <QuickView Product={Product} OptionalPart={true} />
