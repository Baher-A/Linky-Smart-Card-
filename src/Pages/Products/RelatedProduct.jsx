...
const RelatedProduct = ({ SliderProducts, Slideperview }) => {
              ...
              >
                <Box
                  ...
                  sx={{
                    ...
                    bgcolor: Mytheme.palette.mode == 'dark'? "rgba(1, 1, 1, 0.5)":"rgba(10, 10, 10, 0.4)",
                    borderRadius: "25px",
                    padding: "5px",
                  }}
                >
                  ...
                  >
                    <Tooltip title={"Add To wish List"} placement="left" arrow>
                      <Favorite fontSize="medium" sx={{color:'white',fontWeight: 'bold'}} />
                    </Tooltip>
                  </ToggleButton>
                  <ToggleButton
                    value="check"
                  ...
                  >
                    <Tooltip title={"Add To Cart"} placement="left" arrow >
                      <AddShoppingCart fontSize="medium" sx={{ color: 'white', fontWeight: 'bold'}}/>
                    </Tooltip>
                  </ToggleButton>
                  <ToggleButton
                    value="check"
                  ...
                  >
                    <Tooltip title={"QuickView"} placement="left" arrow>
                      <Search fontSize="medium" sx={{color:'white',fontWeight: 'bold'}} />
                    </Tooltip>
                  </ToggleButton>
                </Box>
                ...
                >
                  <Typography
                    sx={{ textAlign: "center", textDecoration: "none",fontWeight:'bold' }}
                  >
